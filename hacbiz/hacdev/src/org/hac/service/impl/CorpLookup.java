 ...
 *
 */
public class CorpLookup extends AbstractService {
	...
	protected Map<String, Object> executeService(Map<String, Object> inputData)
		...
		// 会社管理Noを照合する
		Map<String, Object> existHubMngNoResultMap = orgDao.executeSelect(inputData, "existOrgMngNo");
		...
		resultMap.put("org_data", existHubMngNoResultMap);
